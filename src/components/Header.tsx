...
export default function Header({ activeSection, onNavigate }: HeaderProps) {
  ...
  const PHONE_TEL = "+351939555074"; // ajuste para o número real
  ...
  return (
    <>
      ...
      {/* Mobile drawer (fora do <header> para não herdar stacking contexts) */}
      {mobileMenuOpen && (
        <div className="lg:hidden">
          {/* Wrapper com z-index alto resolve o “sobreposto” quando está scrollado */}
          <div className="fixed inset-0 z-[100]" role="dialog" aria-modal="true">
            ...
            <div
              id="mobile-menu"
              className="absolute right-0 top-0 h-full w-[88%] max-w-sm bg-white shadow-2xl border-l border-gray-200 z-[110]"
              style={{
